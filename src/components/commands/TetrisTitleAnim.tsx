...
const SEQUENCES: Sequence[] = [
  ...
  },
  {
    ...
    pieces: [
      { shape: 'I', col: 0, row: 3, offset: 0 },
      { shape: 'O', col: 5, row: 5, offset: 0.6 },
      { shape: 'S', col: 2, row: 5, offset: 1.2 },
      { shape: 'L', col: 1, row: 3, offset: 1.8 },
      { shape: 'T', col: 3, row: 3, offset: 2.4 },
    ],
  },
  {
    holdBeforeFade: 2.1,
    pieces: [
      { shape: 'L', col: 0, row: 4, offset: 0 },
      { shape: 'I', col: 3, row: 3, offset: 0.6 },
      { shape: 'S', col: 4, row: 5, offset: 1.2 },
      { shape: 'T', col: 0, row: 3, offset: 1.8 },
      { shape: 'O', col: 5, row: 3, offset: 2.4 },
    ],
  },
];
